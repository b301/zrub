...
#define ZRUB_LOG_INFO(format, ...)      _zrub_log(&_zrub_global_logger, ZRUB_LOG_CODE_INFO, _ZRUB_LOG_FUNCMACRO format, __func__, ##__VA_ARGS__)
#define ZRUB_LOG_ERROR(format, ...)     _zrub_log(&_zrub_global_logger, ZRUB_LOG_CODE_ERROR, _ZRUB_LOG_FUNCMACRO format, __func__, ##__VA_ARGS__)
#define ZRUB_LOG_WARNING(format, ...)   _zrub_log(&_zrub_global_logger, ZRUB_LOG_CODE_WARNING, _ZRUB_LOG_FUNCMACRO format, __func__, ##__VA_ARGS__)
#define ZRUB_LOG_DEBUG(format, ...)     _zrub_log(&_zrub_global_logger, ZRUB_LOG_CODE_DEBUG, _ZRUB_LOG_FUNCMACRO format, __func__, ##__VA_ARGS__)
#define ZRUB_LOG_CHECK(format, ...)     _zrub_log(&_zrub_global_logger, ZRUB_LOG_CODE_CHECK, _ZRUB_LOG_FUNCMACRO format, __func__, ##__VA_ARGS__)
